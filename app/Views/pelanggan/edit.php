...
<div class="container-crud">
    <div class="card-crud card-crud--narrow">
        ...
        <form method="post" action="/bellaundry/app/Controllers/PelangganController.php?aksi=update">
            ...
            <div class="<?= !empty($errors['nama']) ? 'form-group-error' : '' ?>">
                <label>Nama</label>
                <input type="text" name="nama" class="input-field" value="<?= htmlspecialchars($pelanggan['nama'] ?? '') ?>" required>
            ...
            <div class="<?= !empty($errors['no_hp']) ? 'form-group-error' : '' ?>">
                <label>No HP</label>
                <input type="text" name="no_hp" class="input-field" value="<?= htmlspecialchars($pelanggan['no_hp'] ?? '') ?>" required>
            ...
            <div class="<?= !empty($errors['alamat']) ? 'form-group-error' : '' ?>">
                <label>Alamat</label>
                <textarea name="alamat" class="input-field" required><?= htmlspecialchars($pelanggan['alamat'] ?? '') ?></textarea>
